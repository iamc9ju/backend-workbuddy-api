...
func setupFiberApp() *fiber.App {
	...
	// Middleware setup
	app.Use("/v1/auth", middleware.LimiterConfig()) //ใช้ middleware กับทุก routes ที่ขึ้นต้นด้วย /v1/auth
	app.Use(middleware.LoggerConfig())              //เซตการเเสดงผลของ Log
	app.Use(helmet.New())                           //ตั้งค่า HTTP Security Headers default config naaa
